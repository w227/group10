...
public class PoiCitySearchActivity extends AppCompatActivity implements OnGetPoiSearchResultListener,
    ...
    public void onGetPoiResult(final PoiResult result) {
        ...
        if (result.error == SearchResult.ERRORNO.NO_ERROR) {
            ...
            mPoiDetailView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
                ...
                public void onGlobalLayout() {
                    int padding = 50;
                    // 添加poi
                    PoiOverlay overlay = new PoiCitySearchActivity.MyPoiOverlay(mBaiduMap);
        ...
        if (result.error == SearchResult.ERRORNO.AMBIGUOUS_KEYWORD) {
            ...
            strInfo += "找到结果";
            Toast.makeText(PoiCitySearchActivity.this, strInfo, Toast.LENGTH_LONG).show();
        }
    }
    ...
    protected class MyPoiOverlay extends PoiOverlay {
        ...
        public boolean onPoiClick(int index) {
            ...
            Toast.makeText(PoiCitySearchActivity.this,poi.address, Toast.LENGTH_LONG).show();
            return true;
        }
    }
