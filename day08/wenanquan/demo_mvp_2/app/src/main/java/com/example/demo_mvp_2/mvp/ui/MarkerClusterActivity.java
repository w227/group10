 ...
 */
package com.example.demo_mvp_2.mvp.ui;
 ...
 */
public class MarkerClusterActivity extends AppCompatActivity implements OnMapLoadedCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mClusterManager.setOnClusterClickListener(new ClusterManager.OnClusterClickListener<MyItem>() {
            ...
            public boolean onClusterClick(Cluster<MyItem> cluster) {
                Toast.makeText(MarkerClusterActivity.this, "有" + cluster.getSize() + "个点", Toast.LENGTH_SHORT).show();
                return false;
            }
        });
        mClusterManager.setOnClusterItemClickListener(new ClusterManager.OnClusterItemClickListener<MyItem>() {
            ...
            public boolean onClusterItemClick(MyItem item) {
                Toast.makeText(MarkerClusterActivity.this, "点击单个Item", Toast.LENGTH_SHORT).show();
                return false;
            }
        });
    }
