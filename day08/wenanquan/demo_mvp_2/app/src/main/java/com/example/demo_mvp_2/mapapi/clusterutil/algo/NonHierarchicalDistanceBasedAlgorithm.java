...
import com.example.demo_mvp_2.mapapi.clusterutil.projection.Bounds;
...
import com.example.demo_mvp_2.mapapi.clusterutil.quadtree.PointQuadTree;
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        final Map<QuadItem<T>, com.example.demo_mvp_2.mapapi.clusterutil.algo.StaticCluster<T>> itemToCluster =
                new HashMap<QuadItem<T>, com.example.demo_mvp_2.mapapi.clusterutil.algo.StaticCluster<T>>();
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
                ...
                com.example.demo_mvp_2.mapapi.clusterutil.algo.StaticCluster<T> cluster =
                        new com.example.demo_mvp_2.mapapi.clusterutil.algo
