...
import com.example.a12_22_zy.clusterutil.projection.Bounds;
...
import com.example.a12_22_zy.clusterutil.quadtree.PointQuadTree;
...
public class NonHierarchicalDistanceBasedAlgorithm<T extends ClusterItem> implements Algorithm<T> {
    ...
    public Set<? extends Cluster<T>> getClusters(double zoom) {
        ...
        final Map<QuadItem<T>, com.example.a12_22_zy.clusterutil.clustering.algo.StaticCluster<T>> itemToCluster =
                new HashMap<QuadItem<T>, com.example.a12_22_zy.clusterutil.clustering.algo.StaticCluster<T>>();
        ...
        synchronized (mQuadTree) {
            for (QuadItem<T> candidate : mItems) {
               ...
               StaticCluster<T> cluster =
                        new com.example.a12_22_zy.clusterutil.clustering.algo
