package com.example.map.luxianguihua.biking;
...
public class BikingFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_biking, container, false);
    ...
    OnGetRoutePlanResultListener listener = new OnGetRoutePlanResultListener() {
        ...
        public void onGetBikingRouteResult(BikingRouteResult bikingRouteResult) {
            ...
            BikingRouteOverlay overlay = new BikingRouteOverlay(mMap);
