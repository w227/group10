...
public class RxPoretorImpl {
    ...
    //有参数没有请求头的get请求
    public <T> void rxGetRequest(String url, Map<String, Object> params, RxObserverCallBack<T> callBack) {
    ...
    //没有参数有请求头的get请求
    public <T> void rxGetRequest(String url, HashMap<String, Object> headers, RxObserverCallBack<T> callBack) {
    ...
    //有参数有请求头的get请求
    public <T> void rxGetRequest(String url, HashMap<String, Object> headers, Map<String, Object> params, RxObserverCallBack<T> callBack) {
    ...
    //有参数但没有请求头的post请求
    public <T> void rxPostRequest(String url, Map<String, Object> params, RxObserverCallBack<T> callBack) {
    ...
    //没有参数有请求头的post请求
    public <T> void rxPostRequest(String url, HashMap<String, Object> headers, RxObserverCallBack<T> callBack) {
