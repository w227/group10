...
public class HomeActivity2 extends BaseActivity {
    @BindView(R.id.home_act_frame)
    FrameLayout mHomeActFrame;
    @BindView(R.id.home_act_nav)
    BottomNavigationView mHomeActNav;
...
//        StatusBarUtil.hideShowStatusBar(this);
        ...
        mHomeActNav.setItemIconTintList(null);
        //让第0个tab默认选中
        mHomeActNav.setSelectedItemId(R.id.nav_home);
        //让第几个tab默认选中
//        mHomeActNav.setSelectedItemId(mHomeActNav.getMenu().getItem(1).getItemId());

        mFragments[0] = new HomeFragment3();
        ...
        initLoadFragment(R.id.home_act_frame, 0);
    ...
    protected void initListener() {
        ...
        mHomeActNav.setOnNavigationItemSelectedListener(itemSelListener);
