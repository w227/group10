...
import com.example.day09.engine.adapter.FragmentHomeRvAdapter;
import com.example.day09.engine.adapter.FragmentHomeRvBean;
...
public class HomeFragment extends BaseFragment {
    ...
    protected void init() {
        ...
        fragmentHomeRv.setLayoutManager(new LinearLayoutManager(App.context(), RecyclerView.VERTICAL, false));
        FragmentHomeRvAdapter fragmentHomeRvAdapter = new FragmentHomeRvAdapter(getList(), App.context());
