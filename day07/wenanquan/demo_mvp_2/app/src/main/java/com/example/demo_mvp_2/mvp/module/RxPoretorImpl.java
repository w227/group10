...
import com.example.demo_mvp_2.di.component.DaggerOkComponent;
...
public class RxPoretorImpl {
    ...
    //没有参数也没有请求头的get请求
    public <T> void rxGetRequest(String url, RxObservableCallBack<T> callBack) {
        RxOperator.threadTransFormer(mApiService.requestGetData(url))
                .subscribe(new RxObserver(callBack));
    }

    //有参数没有请求头的get请求
    public <T> void rxGetRequest(String url, Map<String, T> params, RxObservableCallBack<T> callBack) {
    ...
    //没有参数有请求头的get请求
    public <T> void rxGetRequest(String url, HashMap<String, T> headers, RxObservableCallBack<T> callBack) {
    ...
    //有参数有请求头的get请求
    public <T> void rxGetRequest(String url, HashMap<String, T> headers, Map<String, T> params, RxObservableCallBack<T> callBack) {
    ...
    //没有参数也没有请求头的post请求
    public <T> void rxPostRequest(String url, RxObservableCallBack<T> callBack) {
        RxOperator.threadTransFormer(mApiService.requestPostData(url))
                .subscribe(new RxObserver(callBack));
    }

    //没有参数也有请求头的post请求
    public <T> void rxPostRequest(String url, HashMap<String, T> headers, RxObservableCallBack<T> callBack) {
