...
public class RvJingApret extends RecyclerView.Adapter {

    private ArrayList<YanBean.DataBean.ExpTopBean.ListBean> list;
    private Context context;

    public RvJingApret(ArrayList<YanBean.DataBean.ExpTopBean.ListBean> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        YanBean.DataBean.ExpTopBean.ListBean listBean = list.get(position);
