...
public class RvTuApret extends RecyclerView.Adapter {

    private ArrayList<TuBean.DataBean.TongQianTopBean.ListBean> list;
    private Context context;

    public RvTuApret(ArrayList<TuBean.DataBean.TongQianTopBean.ListBean> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        TuBean.DataBean.TongQianTopBean.ListBean listBean = list.get(position);
