...
package com.example.baidumap.map.makercluster.clusterutil.view;
...
import com.example.baidumap.map.makercluster.IconGenerator;
import com.example.baidumap.map.makercluster.MarkerManager;
import com.example.baidumap.map.makercluster.clusterutil.Cluster;
import com.example.baidumap.map.makercluster.clusterutil.ClusterItem;
import com.example.baidumap.map.makercluster.clusterutil.ClusterManager;
import com.example.baidumap.map.makercluster.clusterutil.algo.NonHierarchicalDistanceBasedAlgorithm;
import com.example.baidumap.map.makercluster.clusterutil.projection.Point;
import com.example.baidumap.map.makercluster.clusterutil.projection.SphericalMercatorProjection;
import com.example.baidumap.widget.SquareTextView;
