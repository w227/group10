...
public class FoundFragment extends Fragment {
    ...
    private TabLayout mFoundTab;
    private ViewPager mFoundVp;
    ...
    private void initView(@NonNull final View itemView) {
        mFoundTab = (TabLayout) itemView.findViewById(R.id.tab_found);
        mFoundVp = (ViewPager) itemView.findViewById(R.id.vp_found);
        ...
        mFoundVp.setAdapter(vpAdapter);

        mFoundTab.setupWithViewPager(mFoundVp);

        mFoundVp.setCurrentItem(1);
    }
}