...
import com.example.day09.mvp.model.bean.Choose_courseBean;
import com.example.day09.engine.adapter.ChooseRvAdapter;
import com.example.day09.mvp.ui.activity.HomeActivity;
...
public class CourseFragment extends BaseFragment {
    ...
    @Override
    protected void init() {
        mChooseRv.setLayoutManager(new LinearLayoutManager(App.context(), RecyclerView.VERTICAL,false));
